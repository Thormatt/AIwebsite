...
function showNotification(message, type = 'info') {
    ...
    notification.style.cssText = `
        ...
        right: 20px;
        padding: 1rem 1.5rem;
        background: ${type === 'success' ? 'linear-gradient(135deg, #10b981 0%, #059669 100%)' : 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)'};
        color: white;
        border-radius: 8px;
...
console.log('AI Consulting website loaded successfully!');